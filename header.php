...
<div id="page" class="hfeed site">
	...
	<header id="masthead" class="site-header" role="banner">
		...
		<nav id="site-navigation" class="navigation-main" role="navigation">
			<h1 class="menu-toggle"><?php _e( 'Menu', 'sstr_theme' ); ?></h1>
			<div class="screen-reader-text skip-link"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'sstr_theme' ); ?>"><?php _e( 'Skip to content', 'sstr_theme' ); ?></a></div>
